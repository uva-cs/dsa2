...
```{python}
#| output: asis
# flow graph is 13.69,9.69 in size, non-flow graph is 8.53,9.64 in size
bipartite_graph(8.53,9.64,0,False)
```
:::
</td></tr></table>
...
#| output: asis
# flow graph is 13.69,9.69 in size, non-flow graph is 8.53,9.64 in size
bipartite_graph(8.53,9.64,1,False)
```
:::
</td></tr></table>
...
#| output: asis
# flow graph is 13.69,9.69 in size, non-flow graph is 8.53,9.64 in size
bipartite_graph(8.53,9.64,2,False)
```
:::
</td></tr></table>
...
#| output: asis
# flow graph is 13.69,9.69 in size, non-flow graph is 8.53,9.64 in size
bipartite_graph(8.53,9.64,3,False)
```
:::
</td></tr></table>
...
#| output: asis
# flow graph is 13.69,9.69 in size, non-flow graph is 8.53,9.64 in size
bipartite_graph(13.69,9.69,3,True)
```
:::
</td></tr></table>
