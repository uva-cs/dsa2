...
digraph graph23 {
    ...
    b -> t [label=<<br/>1>];
    s -> c [label="2";fontcolor=magenta;dir=back;color=magenta];
    c -> d [label="1"];
    c -> a [headlabel=<<table border="0"><tr><td>&nbsp;&nbsp;</td><td>3</td></tr></table>>];
    b -> c [label="1"];
    d -> b [label="3 "];
...
::: {.svg-100}
```{dot}
// this duplicates the one in the reductions column
digraph graph25 {
    _background="
c 7 -#ff00ff  C 7 -#DDA0DD  P 8  
10 -15  -10 10  -10 170  30 210  100 210  120 180  120 100  40 -15
...
<img src="graphs/reductions/bipartite_graph-8.53-9.64-0.svg">
...
<table class="bipartite"><tr><td style="max-width:500px !important">
::: {.r-stack style="height:100%"}
<img src="graphs/reductions/bipartite_graph-8.53-9.64-1.svg">
...
<table class="bipartite"><tr><td style="max-width:500px !important">
::: {.r-stack style="height:100%"}
<img src="graphs/reductions/bipartite_graph-8.53-9.64-2.svg">
...
<table class="bipartite"><tr><td style="max-width:500px !important">
::: {.r-stack style="height:100%"}
<img src="graphs/reductions/bipartite_graph-8.53-9.64-3.svg">
...
</td><td style="vertical-align:middle">How could we solve this?</td></tr></table>
...
<table class="bipartite bipartite_flow"><tr><td style="vertical-align:middle">
::: {.r-stack style="height:100%"}
<img src="graphs/reductions/bipartite_graph-13.69-9.69-0-True-True.svg">

<table style="width:50% !important;margin-bottom:70px !important;margin-left:110px !important">
<tr><td> ![](https://engineering.virginia.edu/sites/default/files/styles/square_xxsml/public/Headshot.webp?itok=5IwaFPya){style=""} </td><td> </td><td> ![](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Sobaka_Husky.JPG/940px-Sobaka_Husky.JPG){style=""} </td></tr>
<tr><td> ![](https://engineering.virginia.edu/sites/default/files/styles/square_xxsml/public/2024-07/RobbieHott-2023.JPG?h=83d1c70a&itok=kpjw11sp){style=""} </td><td> </td><td> ![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Labrador_Retriever_snow.jpg/1196px-Labrador_Retriever_snow.jpg){style=""} </td></tr>
<tr><td> ![](https://engineering.virginia.edu/sites/default/files/styles/square_xxsml/public/Pettit3.JPG?h=7d5d1757&itok=jvoP0ymk){style=""} </td><td> </td><td> ![](https://upload.wikimedia.org/wikipedia/commons/f/f4/MiniDachshund1_wb.jpg){style=""} </td></tr>
<tr><td> ![](https://www.cs.virginia.edu/~asb/images/me.jpg){style=""} </td><td> </td><td> ![](https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Jonangi.jpg/1280px-Jonangi.jpg){style=""} </td></tr>
...
<table class="bipartite bipartite_flow"><tr><td style="vertical-align:middle">
::: {.r-stack style="height:100%"}
<img src="graphs/reductions/bipartite_graph-13.69-9.69-3-True-True.svg">
...
//| fig-width: 1
//| fig-height: 1.5
graph g { bgcolor=transparent;x [fontname="Arial",shape=cylinder,label=<A>,fontsize=48,style=filled,fillcolor=red]; }
```
:::
</td>
...
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=rarrow,label=<Aim duct at door,<br/>insert keg>,fontsize=12,height=0.6,color=red,width=2]; }
```
:::
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
::: {.svg-60 .no-svg-margins style="padding: 0 10px 0 10px !important" .fragment fragment-index=6}
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=larrow,label=<Put fire under the keg>,fontsize=12,height=0.6,color=red,width=2]; }
```
:::
</div>
:::
...
//| fig-width: 1
//| fig-height: 1.75
graph g { bgcolor=transparent;x [fontname="Arial",shape=rect,label=<B>,fontsize=48,style=filled,fillcolor=yellow;height="1.75in";width="1in"]; }
```
:::
</td>
...
<table class="bipartite bipartite_flow2"><tr><td style="max-width:500px !important">
::: {.r-stack style="height:100%"}
<img src="graphs/reductions/bipartite_graph-8.53-9.64-0.svg">
...
<table class="bipartite bipartite_flow3"><tr><td style="vertical-align:middle">
::: {.r-stack style="height:100%"}
<img src="graphs/reductions/bipartite_graph-13.69-9.69-0-True-True.svg">
...
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=rarrow,label="",fontsize=12,height=0.6,color=red,width=2]; }
```
:::
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
::: {.svg-60 .no-svg-margins style="padding: 0 10px 0 10px !important" .fragment data-fragment-index=6}
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=larrow,label="",fontsize=12,height=0.6,color=red,width=2]; }
```
:::
</div>
...
::: {.svg-60 .no-svg-margins style="padding: 0 10px 0 10px !important;z-index:2"}
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=larrow,label="Use edges with flow",fontsize=12,height=0.6,color=red,width=2]; }
```
:::
...
//| fig-width: 1
//| fig-height: 1.75
graph g { bgcolor=transparent;x [fontname="Arial",shape=rect,label=<C>,fontsize=48,style=filled,fillcolor=green;height="1.75in";width="1in"]; }
```
:::
</td>
...
//| fig-width: 1
//| fig-height: 1.5
graph g { bgcolor=transparent;x [fontname="Arial",shape=cylinder,label=<X>,fontsize=48,style=filled,fillcolor=red]; }
```
:::
</td></tr></table>
...
//| fig-width: 1
//| fig-height: 1.75
graph g { bgcolor=transparent;x [fontname="Arial",shape=rect,label=<Y>,fontsize=48,style=filled,fillcolor=yellow;height="1.75in";width="1in"]; }
```
:::
...
<tr><td><table class='bluenote fragment' data-fragment-index=1><tr><td>Suppose I know a worst-case lower-bound of $\Omega(f(n))$ for $A$</td></tr></table></td></tr>
<tr><td>
::: {.r-stack}
<p style="text-align:center"><img src="graphs/reductions/darrow.svg" class="svg-60 no-svg-margins" style="margin:auto !important"></p>
...
::: {.svg-60 .no-svg-margins style="padding: 0 10px 0 10px !important"}
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=rarrow,label=<reduces to>,fontsize=12,height=0.6,color=red,width=2]; }
```
:::
...
//| fig-width: 2
//| fig-height: 3
graph g { bgcolor=transparent;x [fontname="Arial",shape=rect,label=<B>,fontsize=48,style=filled,fillcolor=yellow]; }
```
:::
</td></tr>
...
::: {.svg-60 .no-svg-margins style="padding: 0 10px 0 10px !important"}
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=rarrow,label=<can be used<br/>to make>,fontsize=12,height=0.6,color=red,width=2]; }
```
:::
...
//| fig-width: 2
//| fig-height: 3
graph g { bgcolor=transparent;x [fontname="Arial",shape=rect,label=<Y>,fontsize=48,style=filled,fillcolor=yellow]; }
```
:::
...
::: {.svg-60 .no-svg-margins style="padding: 0 10px 0 10px !important"}
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=rarrow,label=<<i>f(n)</i> reduces to>,fontsize=12,height=0.6,color=red,width=2]; }
```
:::
...
::: {.svg-60 .no-svg-margins style="padding: 0 10px 0 10px !important"}
```{dot}
graph g { bgcolor=transparent;x [penwidth=3;fontname="Arial",shape=rarrow,label=<can be used to make>,fontsize=12,height=0.6,color=red,width=2]; }
```
:::
...
<tr><td><table class='bluenote fragment' data-fragment-index=2><tr><td>Then this can be done in $o(n\log n)$</td></tr></table></td></tr>
<tr><td>
::: {.r-stack}
<p style="text-align:center"><img src="graphs/reductions/darrow.svg" class="svg-60 no-svg-margins" style="margin:auto !important"></p>
...
<tr><td><table class='bluenote fragment' data-fragment-index=1><tr><td>&nbsp;&nbsp;If this could be done in&nbsp;&nbsp;<br>$o(n \log n)$&nbsp;</td></tr></table></td></tr>
<tr><td style="text-align:center">
<p style="text-align:center"><img src="graphs/reductions/darrow.svg" class="svg-60 no-svg-margins" style="margin:auto !important"></p>
</td></tr>
<tr><td><span>Solution for $B$</span></td></tr>
