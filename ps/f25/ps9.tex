...
\begin{enumerate}
    ...
    \item Given this particular problem, in the worst case, which algorithm would be better to use for max flow: Edonds-Karp or Ford-Fulkerson? Recall, from the above question, that we can assume $v=|D| \approx |P| \approx |A|$.
