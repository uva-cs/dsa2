...
A `.tex` file is provided with the questions where you'll also enter your answers (see below), but [here's a PDF file with the questions](ps8.pdf) if you want to see them before you set up the LaTeX project. 
