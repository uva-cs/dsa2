---
title: "DSA2: Problem Set 5"
---

A `.tex` file is provided with the questions where you'll also enter your answers (see below), but [here's a PDF file with the questions](ps5.pdf) if you want to see them before you set up the LaTeX project. 
...
1. Download the [ps5.tex](ps5.tex) file; you will also need the [dsa2.sty](dsa2.sty) file (it's the same as PS0, and won't change this semester).
...
### Deliverable
- Modify the ps5.tex file to complete the problems.
