...
- We have a textbook, but it's available online for free through the UVA library: [Introduction to Algorithms](https://ebookcentral-proquest-com.proxy1.library.virginia.edu/lib/UVA/detail.action?docID=6925615), called "CLRS" after the initials of the authors.
